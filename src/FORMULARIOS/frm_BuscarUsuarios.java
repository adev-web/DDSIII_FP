 ...
 * @author 50763
 */
public class frm_BuscarUsuarios extends javax.swing.JFrame {

    /**
     * Creates new form frm_BuscarUsuarios
     */
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_Atras, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, -1, 30));
    ...
    private void btn_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarActionPerformed
        ...
        if (checkerUser) {
            ...
            JOptionPane.showMessageDialog(this, "El Usuario no fue encontrado\n"
                                                +"Verifique si se digitó Correctamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_BuscarUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_BuscarUsuarios().setVisible(true);
            }
        });
    }
