 ...
 * @author termi
 */
public class frm_buscarUsuario extends javax.swing.JFrame {

  /**
   * Creates new form frmBuscarUsuario
   */
  public frm_buscarUsuario() {
    initComponents();
  }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(frm_buscarUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new frm_buscarUsuario().setVisible(true);
      }
    });
  }
