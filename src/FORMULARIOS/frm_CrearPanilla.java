 ...
 * @author termi
 */
public class frm_CrearPanilla extends javax.swing.JFrame {

  /**
   * Creates new form frmCrearPlanilla
   */
  public frm_CrearPanilla() {
    initComponents();
  }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(frm_CrearPanilla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      @Override
      public void run() {
        new frm_CrearPanilla().setVisible(true);
      }
    });
  }
